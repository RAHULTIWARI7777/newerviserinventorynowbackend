...
namespace backend_dotnet7.Migrations
{
    ...
    [Migration("20231203152041_Add-Migration AddHI")]
    partial class AddMigrationAddHI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.Employee", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.EmployeeHardwareInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.HardwareInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ReplacementDate")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("RetiredDate")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("backend_dotnet7.Core.Entities.EmployeeHardwareInfo", b =>
                {
                    b.HasOne("backend_dotnet7.Core.Entities.Employee", "Employee")
                        .WithMany("EmployeeHardwareInfos")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("backend_dotnet7.Core.Entities.HardwareInfo", "HardwareInfo")
                        .WithMany("EmployeeHardwareInfos")
